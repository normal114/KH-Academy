...
<script type="text/javascript">
	...
	function idCheckProc(){
		var chk = document.getElementsByName("mymember")[0].title;
		if(chk == 'n'){
			alert("id 중복체크를 해주세요!");
			document.getElementsByName("mymember")[0].focus();
		}
	}
	
	function idCheck(){
		var mymember = document.getElementsByName("mymember")[0].value;
		
		if( mymember == null || mymember.trim() == ""){
			alert("id를 입력해 주세요!");
		} else {
			open("logincontroller.jsp?idchk&memberid="+mymember, "", "width=200, height=200");
		}
	}
...
<body>
	...
	<form action="registform.do" method="post">		
		<table border="1">
			<tr>
				<th>아이디</th>
				<td>
