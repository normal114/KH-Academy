			...
			<section id="myboard_insert">
				<table class="board_list">
					...
					<thead>
						...
						<tr>
							<th>내용</th>
							<td><textarea class="noresize" rows="25" cols="70" readonly="readonly">${dto.mycontent }</textarea></td>
						</tr>
						<tr>
							<td colspan="2" align="right"><input type="button" id="mpage01"
								value="수정"
								...
								type="button" id="mpage02" value="목록" onclick="location.href='list.do'" /></td>
						</tr>
					</thead>
				</table>
			</section>
